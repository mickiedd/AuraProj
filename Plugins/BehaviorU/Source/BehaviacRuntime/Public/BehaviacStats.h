 ...
 * 在运行时通过以下方式查看：
 *   stat Behaviac              — 控制台命令
 *   Unreal Insights → Timing → Behaviac
 *
 * 统计层级：
 *   子系统级（游戏线程）
