...
echo [3/3] Building BehaviorULauncher (Release x64) ...
"!MSBUILD!" "%SCRIPT_DIR%BehaviorULauncher.vcxproj" /p:Configuration=Release /p:Platform=x64 /p:WebView2Version=!WV2_VERSION! /p:WebView2PkgBase=!WV2_PKG_BASE! /p:UseWebView2=true /v:minimal /nologo
...
:: required at load time and must live beside BehaviorULauncher.exe.
echo [4/4] Copying WebView2Loader.dll next to BehaviorULauncher.exe ...
copy /Y "!WV2_PKG_BASE!\build\native\x64\WebView2Loader.dll" "%SCRIPT_DIR%BehaviorULauncher.WebView2Loader.dll" >nul
if errorlevel 1 (
...
echo  Executable: %SCRIPT_DIR%BehaviorULauncher.exe
echo ===========================================================================
echo.
pause
endlocal