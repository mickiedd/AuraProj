...
#include "WaitNode.generated.h"

UCLASS(DisplayName = "Wait")
class AURAABILITYGRAPH_API UWaitNode : public UAuraAbilityActionNode
{
    GENERATED_BODY()
...
UCLASS()
class AURAABILITYGRAPH_API UWaitTask : public UAuraAbilityActionTask
{
    GENERATED_BODY()
