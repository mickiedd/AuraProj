...
param(
    ...
    [ValidateRange(1, 65535)] [int]$Port = 17914,
    [ValidateRange(10, 300)] [int]$TimeoutSeconds = 90
)
& (Join-Path $PSScriptRoot 'RunRoleBattleDays1012NetworkSmoke.ps1') -Day 14 -Mode $Mode -EngineRoot $EngineRoot -Port $Port -TimeoutSeconds $TimeoutSeconds
exit $LASTEXITCODE
