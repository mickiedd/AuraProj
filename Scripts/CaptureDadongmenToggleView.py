...
out = str(root / "Dadongmen_V4-toggle-view.png")
print("TASK", unreal.AutomationLibrary.take_high_res_screenshot(1600, 1000, out, None, False, False, unreal.ComparisonTolerance.LOW, "toggle view", 2.0, True))
