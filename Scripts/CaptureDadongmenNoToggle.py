...
out = str(root / "Dadongmen_V4-debug2.png")
print("TASK", unreal.AutomationLibrary.take_high_res_screenshot(1600, 1000, out, None, False, False, unreal.ComparisonTolerance.LOW, "debug2", 2.0, True))
