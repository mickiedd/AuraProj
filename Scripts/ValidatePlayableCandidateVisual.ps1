...
foreach ($page in $pages) {
    ...
    $required = if ($page -like '*right-top*') { @('firearmPanel','hud_firearm','reloadFirearm','hud_merchant') } elseif ($page -like '*left-top*') { @('tutorialState','hud_tutorial','hud_role_state') } else { @('skill_ability_pressed','skill_ability_released') }
