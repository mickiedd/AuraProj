...
echo ========================================
call "%BUILD_BAT%" AuraEditor Win64 Development -Project="%PROJECT_FILE%" -WaitMutex
if %errorlevel% neq 0 (
...
echo.
echo Smoke test run finished. Check "%SCRIPT_DIR%\Saved\Logs\Aura.log" for results.